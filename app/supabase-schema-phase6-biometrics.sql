-- =============================================================
-- SpoonShare: Biometrics & Manual Events Schema (Phase 6)
-- Features: Health Bridge (HRV tracking) + Spoon Ledger Calendar
-- =============================================================
-- Run after: supabase-schema.sql, supabase-schema-phase2.sql,
--            supabase-schema-phase4.sql, supabase-schema-phase5.sql
